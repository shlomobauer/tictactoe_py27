...
if __name__ == '__main__':
 ...
 goFirst = False
 answer = raw_input("Go First? [Y/N]: ")
 if answer.lower()[0] == 'y':
  goFirst = True

 loadBrain = False
 answer = raw_input("Load Robot Brain [Y/N]: ")
 if answer.lower()[0] == 'y':
  loadBrain = True
 ...
 if goFirst :
  ...
  answer = raw_input("Save Robot (for O) Brain? [Y/N]: ")
  ...
  answer = raw_input("Save Robot (for X) Brain? [Y/N]: ")
  if answer and answer.lower()[0] == 'y':
   ai.saveBrainX()
